...
# By Amit kumar
# Take a Look of this Code later we will understand this code...
...
while True:
    print("\nWelcome to the Random Password generator by Amit Kumar\n")
    # print("\n")
...
# This code is written by Amit_kumar
# I also handled the error in this program, to prevent the crash or errors